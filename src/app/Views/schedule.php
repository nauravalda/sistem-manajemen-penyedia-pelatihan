    ...
    <div class='flex flex-col my-5 gap-24'>
        ...
        <div class="flex flex-row">
          <div class='flex w-fit outline outline-1 outline-sys-light-outline-variant rounded-full overflow-hidden gap-0 p-0'>
            ...
            <?php else : ?>
              <button
                class='hover:bg-sys-light-secondary-container focus:bg-sys-light-secondary-container hover-text-purple-900 outline outline-1 outline-sys-light-outline-variant w-[100px] py-[10px] gap-[8px]'
                onclick="window.location.href='/schedule/3'"
              >
            <?php endif; ?>
            ...
            <?php else : ?>
              <button
                class='hover:bg-sys-light-secondary-container focus:bg-sys-light-secondary-container hover-text-purple-900 outline outline-1 outline-sys-light-outline-variant w-[100px] py-[10px] gap-[8px]'
                onclick="window.location.href='/schedule/5'"
              >
            <?php endif; ?>
              <label class='font-sans font-medium text-label-lg'>
                5 Days
            ...
            <?php else : ?>
              <button
                class='hover:bg-sys-light-secondary-container focus:bg-sys-light-secondary-container hover-text-purple-900 outline outline-1 outline-sys-light-outline-variant w-[100px] py-[10px] gap-[8px]'
                onclick="window.location.href='/schedule/7'"
              >
            <?php endif; ?>
              <label class='font-sans font-medium text-label-lg'>
                7 Days
